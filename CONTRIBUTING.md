...
- Clone your fork locally and create a feature branch.
  - Example branch name: `add-new-abiogenesis-resource`.
- Make your changes.
...
git clone https://github.com/YOUR-USERNAME/awesome-abiogenesis.git
cd awesome-abiogenesis

# 2) Add upstream remote
git remote add upstream https://github.com/timtyler/awesome-abiogenesis.git
